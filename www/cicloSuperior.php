...
<main>
    <div class="container mt-5">
        <div class="row border-bottom mb-5">
            <div class="col-12 fs-2 fw-bold d-flex justify-content-center"><p>Ciclo Superior</p></div>
            <div Class="col-12 my-3">El ciclo superior tiene una duracion de cuatro años y posee la modalidad de Educación Técnico Profesional en donde se definen las tecnicaturas que se mostraran mas abajo.
...
Cada una de estas orientaciones posee una Formacion cientifico-tecnologica, la cual tiene que ver con diferentes saberes que otorgan conocimientos, habilidades, destrezas y valores. Esta organizada en modulos y su funcion es comprender, integrar y profundizar los contenidos que introducen a los aspectos específicos de cada especialidad.</div>
        ...
        <div class="row">
            <div class="col-12 fs-2 fw-bold d-flex justify-content-center">
                <p>Especializaciones</p>
            </div>
        </div>
        <div class="row d-flex">
            <div class="col-12 col-sm-6 col-md-4 pb-4 d-flex justify-content-center">
                <div class="card p-0" style="width: 24rem;">
