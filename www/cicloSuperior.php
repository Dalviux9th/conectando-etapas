                    ...
                    <ul class="navbar-nav mb-2 mb-lg-0 p-md-1">
                        ...
                        <li class="nav-item dropdown-center">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="./FAQ.php">Preguntas Frecuentes</a></li>
    ...
    <div class="row justify-content-center">
        ...
        <div class="row font-left mt-5">
            ...
            <div class="col-12 col-md-8">
                ...
                <p class="fs-5">Siguiendo con las diferentes materias, debemos agregar las materias científico-tecnológicas: 
                    <ul>
                        <li class="fs-5">Matemática, con una carga de 144 horas.</li>
                        <li class="fs-5">Física, con una carga de 108 horas.</li>
                        <li class="fs-5">Química, con una carga de 72 horas.</li>
                    </ul>
                </p>
            </div>
        </div>
        ...
        <div class="row font-left">
            ...
            <div class="col-12 col-md-8">
                ...
                <p class="fs-5">En este año contamos a su vez con una materia correspondiente a las materias científico-específicas: Matemática Aplicada. Con una carga de 72 horas.</p>
            </div>
        </div>
        <hr>
