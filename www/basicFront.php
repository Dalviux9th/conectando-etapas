            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="extendNav">
                    <ul class="navbar-nav mb-2 mb-lg-0 p-md-1">
                        ...
                        <li class="nav-item" ><a class="nav-link" href="./superiorFront.php">Ciclo Superior</a></li>
    ...
    <div class="row">
        ...
        <div class="card text-center">
            <div class="card-header">
                <h3 class="card-title">Primer año</h2>
            </div>
            <div class="card-body">
                <h4 class="card-title">Información</h5>
        ...
        <div class="card text-center">
            <div class="card-header">
                <h3 class="card-title">Segundo año</h2>
            </div>
            <div class="card-body">
                <h4 class="card-title">Información</h5>
        ...
        <div class="card text-center">
            <div class="card-header">
                <h3 class="card-title">Tercer año</h2>
            </div>
            <div class="card-body">
                <h4 class="card-title">Información</h5>
