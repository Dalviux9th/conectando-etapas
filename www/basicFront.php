...
<header class="header">
    ...
    <main class="container mb-5 ">
        <h1 class="text-center mt-5 mb-3">Ciclo Básico</h1>
        <p class="fs-5"> El ciclo basico técnico tiene una duracion de tres años y tiene una Formación Técnica Específica la cual esta comprendida por los saberes del mundo del trabajo, el conocimiento del sistema socio-productivo local, la formacion ciudadana y la adquisicion de saberes en lo que respecta a la produccion de conocimientos cientificos y tecnologicos.</p>
        <p class="fs-5">Una de las características principales de la Formación Específica en el ciclo Básico es favorecer el desarrollo de capacidades que resultarán necesarias en las diferentes tecnicaturas que el alumno pueda elegir en el ciclo superior.</p>
        ...
        <div class="row font-left">
            ...
            <div class="col-md-8">
                ...
                <h4>Talleres</h4>
                <p class="fs-5">Dentro de la formación científico-tecnológica se dictan tres materias: Procedimientos Técnicos, Lenguajes Tecnológicos y Sistemas Tecnológicos, cada una con una carga horaria anual de 72 horas, y con 6 módulos semanales</p>
            </div>
        </div>
        ...
        <div class="row font-left">
            <div class="col-12 col-md-4">
                <img src="../www/imagenes/electro.jpg" alt="" class="p-0 m-0 img-fluid h-100">
            </div>
