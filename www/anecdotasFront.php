...
<body>
  ...
  <hr>
    ...
    <div class="dropdown">
      ...
      <div class="row mt-3 mb-3 rounded collapse" id="anec">
        ...
        ?>
          <div class='row justify-content-center mb-2'>
            <div class='col-12 col-sm-10 col-md-8 bg-light'>
          ...
          <div class="col-3 col-sm-2 col-md-1 Reaccion pb-1 p-0" id="<?php echo $datos['id_anec']; ?>-sad"> 
            <div class="row me-1">
              ...
              <div class="col-6 ps-0" id="number-sad-<?php echo $datos['id_anec'];?>"><?php echo $clave->sad;?></div>
            </div>
          </div>
