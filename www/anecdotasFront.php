...
<hr>
  ...
  <?php
    ...
    while ($datos = mysqli_fetch_array($resultado)) {
        ...
        echo '<div class="row mt-3 mb-3 border border-1 rounded collapse" id="anec">
        <div class="row text-center justify-content-center">
            <div class="col-12 col-md-2 me-2">
                <strong>'.$datos[3].'</strong><br>
                <strong>'.$datos[4].'</strong>
